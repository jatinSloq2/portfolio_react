...
const Footer = () => {
  return (
    <footer className="bg-white text-black dark:bg-zinc-950 dark:text-white  border-dashed w-full border-t-2 border-gray-500">
      <div className=" mx-auto relative px-4 max-w-[1200px] grid grid-cols-1 md:grid-cols-3 gap-8 text-center border-l-2 border-r-2 md:text-left py-6 border-dashed border-gray-500">
        ...
        <div className='mb-10'>
          ...
          <div className="flex items-center justify-center md:justify-start gap-4">
            ...
            <a href="https://www.linkedin.com/in/jatin-singh-70004b365?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 transition">
              <i className="fab fa-linkedin-in text-2xl"></i>
            </a>
            <a href="https://github.com/jatinSloq2" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 transition">
              <i className="fab fa-github text-2xl"></i>
            </a>
            <a href="https://www.instagram.com/jatin.s_07" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 transition">
